...
(One of) Euler's formula (Equation~(\ref{eqn:euler})) says
\begin{align*}
% Use \yesnumbertarget\label{...}
% to place the target at a good location.
\yesnumbertarget
\label{eqn:euler}
% {\ } is for placement of equation target.
{\ }
e^{i\pi}+1&\\ &{}=0.
% The extra space should be symmetric.
{\ }
% The equation number can be placed on a different line.
\yesnumbertag
\end{align*}
...
\subsection{Link that spans multiple pages}
