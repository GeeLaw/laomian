...
\texttt{absurdum=hitwall} & ${\texttt{\textbackslash absurdum}=\absurdumhitwall}$ \\
\texttt{absurdum=lightning} & ${\texttt{\textbackslash absurdum}=\absurdumlightning}$ \\
...
\subsection{Format- and Option-Dependent Control \underlined{Sequences}}
...
\begin{proofsketch}
This is \texttt{\textbackslash begin\{proofsketch\}}.
\end{proofsketch}
...
\begin{align*}
&\texttt{\textbackslash begin\{proofsketch\}}\\%
&\texttt{[\textbackslash HyperTargetToThisLine\{pf:proposition8\}\%}\\
&\texttt{Proposition\textasciitilde\textbackslash ref\{prop:proposition8\}]}\\
&\texttt{...}\\
&\texttt{\textbackslash end\{proofsketch\}}
\qedhere
\end{align*}
\end{proofsketch}
...
\begin{proof}
In this proof,
\texttt{\string\let\string\qedsymbol\string\absurdum}
[\absurdum, $\absurdum$]
(\absurdum) $(\absurdum)$.
...
\begin{proof}
In this proof,
\texttt{\string\let\string\qedsymbol\string\absurdumhitwall}
...
\begin{proof}
In this proof,
\texttt{\string\let\string\qedsymbol\string\absurdumlightning}
...
\begin{align*}
&\texttt{\textbackslash begin\{proposition\}}\\
&\texttt{[\textbackslash hyperlink\{pf:proposition8\}\{\textbackslash P\}]}\\
&\texttt{...}\\
&\texttt{\textbackslash end\{proposition\}}
\end{align*}
\end{proposition}
