...
%   no-microtype
%       Do not load microtype package.
%       The choice should be made at the beginning, because toggling it
%         usually causes significant reflowing in the typesetting result.
